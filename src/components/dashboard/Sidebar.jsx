    ...
    <header className='bg-white w-[250px] h-screen relative'>
        ...
        <nav className='p-7'>
            <ul className='flex flex-col gap-5'>
                <li>
                    <Link href="/dashboard" className={`flex items-center gap-4 ${pathname.startsWith('/dashboard')  ? 'text-[#62A0AA]' : 'text-[#000000]'}`}>
                        <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                            width="25px" height="25px" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlSpace="preserve" fill={pathname.startsWith('/dashboard') ? '#62A0AA' : '#000000'}>
