		...
		<li>
			<Link
				...
				className={`flex items-center gap-4 ${
					isActive ? "text-brandCyan" : "text-brandBlack"
				}`}
			>
				{React.cloneElement(icon, {
					fill: isActive ? "#62A0AA" : "#4C4C4C",
					width: "24",
					height: "24",
				})}
				{text}
...
const Sidebar = () => {
	...
	const dashboardIcon = (
		<svg
			...
			xmlSpace="preserve"
			fill={pathname.startsWith("/dashboard") ? "#62A0AA" : "#4C4C4C"}
		>
			<path
	...
	const settingsIcon = (
		<svg
			...
			viewBox="0 0 24 24"
			fill={
				pathname.startsWith === settingsPathname ? "#62A0AA" : "#4C4C4C"
			}
			xmlns="http://www.w3.org/2000/svg"
		>
			<path
