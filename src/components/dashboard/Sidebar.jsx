...
const Sidebar = () => {
	...
	const settingsIcon = (
		<svg
			...
			height="24"
			viewBox="0 0 24 24"
			fill={pathname.startsWith(settingsPathname) ? "#54696c" : "#4C4C4C"}
			xmlns="http://www.w3.org/2000/svg"
		>
			<path
	...
	const subscriptionsIcon = (
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
			<g id="Subscription">
				<path style="#000000" d="M28 38h-8a2 2 0 0 1 0-4h8a2 2 0 0 1 0 4z" />
				<path style="#000000"
				...
				<rect style="#000000" x="16" y="10" width="16" height="8" rx="1" />
				<rect style="#000000" x="35" y="13" width="9" height="8" rx="1" />
				<rect style="#000000" x="4" y="13" width="9" height="8" rx="1" />
				<path style="#000000"
