    ...
    <header className='bg-white w-[250px] h-screen'>
        ...
        <nav className='p-7'>
            <ul className='flex flex-col gap-5'>
                <li>
                    {/* ${pathname === '/dashboard' ? 'text-[#62A0AA]' : 'text-[#000000]'} */}
                    <a href="/dashboard" className={`flex items-center gap-4 `}>
                        <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                            width="25px" height="25px" viewBox="0 0 64 64" enableBackground="new 0 0 64 64" xmlSpace="preserve" fill="black">
