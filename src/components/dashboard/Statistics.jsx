      ...
      <div className="flex justify-between">
        <div className="max-w-[600px] h-full">
          ...
          <p className="font-light">
            Charting flight durations within a specific time frame, offering a
            clear overview for analysis.
          </p>
        ...
        <div className="max-w-[600px] h-full">
          ...
          <p className="font-light">
            A visual summary of flight time across regions, highlighting minutes
            flown in a specified period.
          </p>
