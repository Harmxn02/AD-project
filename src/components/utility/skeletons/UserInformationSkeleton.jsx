...
const UserInformationSkeleton = () => {
	...
	return (
		<div className="flex flex-col gap-2 items-center">
			...
			<div className="h-4 w-[13ch] mx-auto bg-brandTeal animate-pulse rounded-full mt-4 "></div>
			<div className="h-3 w-[15ch] mx-auto bg-gray-200 animate-pulse rounded-full"></div>
		</div>
	);
};
