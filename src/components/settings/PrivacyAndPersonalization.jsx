				...
				<>
					...
					<section className="flex flex-col gap-5">
						...
						<SettingsContainer>
							...
							<div className="flex flex-col gap-4">
								<div>
									...
									<SettingsSubtitle>Send me messages for payment reminders.</SettingsSubtitle>
								</div>
								<div>
									<Toggle
										text="Carrier Pigeon"
										state={preferences.carrierPigeon}
										id="carrierPigeon"
									/>
								</div>
							</div>
						...
						<SettingsContainer>
							...
							<div className="flex flex-col gap-4">
								<div>
									<SettingsTitle>Marketing Communication</SettingsTitle>
									<SettingsSubtitle>
										Learn about new exploration areas, scholarship opportunities and upcoming
										special events.
									</SettingsSubtitle>
									<div className="my-6">
										...
										<Toggle
											text="Email"
											state={preferences.upcomingSpecialEvents.email}
											id="upcomingSpecialEvents.email"
										/>
										<Toggle
											text="SMS"
											state={preferences.upcomingSpecialEvents.sms}
											id="upcomingSpecialEvents.sms"
										/>
									</div>
									<div className="my-6">
										...
										<Toggle
											text="Email"
											state={preferences.newExplorationAreas.email}
											id="newExplorationAreas.email"
										/>
										<Toggle
											text="SMS"
											state={preferences.newExplorationAreas.sms}
											id="newExplorationAreas.sms"
										/>
									</div>
									<div className="my-6">
										...
										<Toggle
											text="Email"
											state={preferences.educationalOpportunities.email}
											id="educationalOpportunities.email"
										/>
										<Toggle
											text="SMS"
											state={preferences.educationalOpportunities.sms}
											id="educationalOpportunities.sms"
										/>
									</div>
								</div>
							</div>
