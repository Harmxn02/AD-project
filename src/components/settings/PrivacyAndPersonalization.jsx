                        ...
                        <div>
                            ...
                            <div className="my-6">
                                ...
                                <Toggle
                                    text="Email"
                                    state={
                                        preferences.upcomingSpecialEvents.email
                                    }
                                ...
                                <Toggle
                                    text="SMS"
                                    state={
                                        preferences.upcomingSpecialEvents.sms
                                    }
                            ...
                            <div className="my-6">
                                ...
                                <Toggle
                                    text="Email"
                                    state={
                                        preferences.newExplorationAreas.email
                                    }
                            ...
                            <div className="my-6">
                                ...
                                <Toggle
                                    text="Email"
                                    state={
                                        preferences.educationalOpportunities
                                            .email
                                    }
                                ...
                                <Toggle
                                    text="SMS"
                                    state={
                                        preferences.educationalOpportunities.sms
                                    }
