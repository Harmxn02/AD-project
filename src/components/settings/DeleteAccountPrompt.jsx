			...
			<SettingsContainer>
				...
				<div className="flex flex-col gap-4">
					<div>
						...
						<SettingsSubtitle>
							This action is
							<strong className="font-semibold"> permanent</strong> and can not be
							<strong className="font-semibold"> reversed</strong>{" "}
						</SettingsSubtitle>
					</div>
					...
					<div className="flex flex-col gap-5">
						...
						<div className="flex gap-5">
							...
							<Link href="/settings" className="border rounded-md px-4 py-3 font-medium">
								Cancel
							</Link>
						</div>
					</div>
