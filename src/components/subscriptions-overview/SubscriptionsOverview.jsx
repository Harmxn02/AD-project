...
const SubscriptionsOverview = () => {
	return (
		<div className="selection:bg-[#62a0aa71] min-h-screen px-8 bg-brandDarkPurple">
			<header className="flex items-center gap-2 mb-3">
				<Link href="/" className="h-[10vh] z-10 flex items-center gap-2">
					<h1 className="text-brandPink text-2xl font-bold">X-Plor</h1>
					<svg
						className="h-6 w-6"
						width="349"
						height="349"
			...
			<main className="flex flex-col justify-center items-center">
				<div className="text-center">
					...
					<h3 className="text-5xl bg-gradient-to-r from-brandPink to-white bg-clip-text text-transparent font-semibold mb-4">
						Simple and
						<br />
						<span className="bg-gradient-to-r from-brandPink to-white bg-clip-text text-transparent">
						Transparant pricing
						</span>
					</h3>
